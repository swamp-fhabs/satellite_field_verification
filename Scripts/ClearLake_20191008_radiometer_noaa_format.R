...
## SAMPLING DATE: 10-Aug-2019

## Specify pathways
base_dir <- "Data/20191008_ClearLake"
metadata_file <- file.path(base_dir, "radiometer_ClearLake_20191008.txt")
...
basePath <- "C:\\Users\\KBouma-Gregson\\Documents\\Satellite_CI_index\\satellite_field_verification_git\\Data\\20191008_ClearLake\\noaa_files"
...
map(noaa_file_dirs, function(x){write_batch_file(samp_dir = x,
                                                 ...
                                                 exe_path = exe_file, 
                                                 cal_path = cal_file, 
                                                 batch_name = "ClearLake_20191008_batch.bat", 
                                                 out_dir = noaa_out_dir)
})
