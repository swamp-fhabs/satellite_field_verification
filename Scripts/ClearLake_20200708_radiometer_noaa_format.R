...
noaa_file_dirs <- list.dirs(noaa_out_dir, full.names= FALSE)[c(-1, -17)]
...
exe_file <- '"C:\\Users\\KBouma-Gregson\\OneDrive - Water Boards\\Satellite_CI_index\\satellite_field_verification_git\\Data\\ASD_processing\\test_asd_group.exe\\"'
# Location of the 10% spectralon calibration file
cal_file <- '"C:\\Users\\KBouma-Gregson\\OneDrive - Water Boards\\Satellite_CI_index\\satellite_field_verification_git\\Data\\ASD_processing\\OIMA_10%_Spectralon_Calibration_SRT-10-050.txt"'
...
map(noaa_file_dirs, function(x){write_batch_file(samp_dir = x,
                                                 ...
                                                 exe_path = exe_file, 
                                                 cal_path = cal_file, 
                                                 batch_name = "ClearLake_20200708_batch.bat", 
                                                 out_dir = noaa_out_dir)
})
