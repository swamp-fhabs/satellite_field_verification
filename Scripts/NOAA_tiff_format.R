...
noaa.field.info <- read_tsv("Data/NOAA_tiff_format.tsv")
...
# names(noaa.field.info) <- c("field_path", "NOAA_path", "DFGWATERID", "utm", "waterbody")
#write_tsv(noaa.field.info, "Data/NOAA_tiff_format.tsv")



# Field sampling locations
lsa_20190801_locations <- sampling_locations(noaa.field.info$field_path[1], utm= 10)
clr_20190807_locations <- sampling_locations(noaa.field.info$field_path[2], utm= 10)
spr_20190812_locations <- sampling_locations(noaa.field.info$field_path[3], utm= 10)
alm_20190815_locations <- sampling_locations(noaa.field.info$field_path[4], utm= 10)
clr_20190816_locations <- sampling_locations(noaa.field.info$field_path[5], utm= 10)
clr_20191008_locations <- sampling_locations(noaa.field.info$field_path[6], utm= 10)
