...
sampleName <- "Waterbody_YYYMMDD"




#### WRANGLE/TIDY DATA BEFORE CALCULATING REMOTE REFLECTANCE VALUES ####
...
# and moves them all into a single sample folder
noaa_file_dirs <- list.dirs(noaa_out_dir, full.names= FALSE)[-1]
